...
export default function PerkCount() {
  ...
  return (
    <Card className="w-full p-3 transition-all duration-300 bg-card/60 md:backdrop-blur-md border-border/50 ring-1 ring-primary/5 hover:ring-primary/10 rounded-xl">
