...
export default function ClassDetails() {
  ...
  return (
    <Card className="w-full flex flex-col gap-4 px-4 py-5 transition-all duration-300 bg-card/60 md:backdrop-blur-md border-border/50 ring-1 ring-primary/5 hover:ring-primary/10 shadow-lg rounded-2xl">
